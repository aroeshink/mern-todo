            ...
            <div className="row">
                <div className="col-md-12">
                    <FormGroup>
                        ...
                        <FormControl type="text" placeholder="Enter Todo" name="todoText" defaultValue={props.todoData.todoText} />
                    </FormGroup>
                </div>
                <div className="col-md-12">
                    <FormGroup>
                        <ControlLabel>Description: </ControlLabel>
                        <FormControl componentClass="textarea" placeholder="Enter description" name="todoDesc" defaultValue={props.todoData.todoDesc} />
                    </FormGroup>
                </div>
            </div>
            <FormGroup>

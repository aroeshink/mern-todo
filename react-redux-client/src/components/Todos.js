    ...
    render() {
        ...
        return(
            <div className="col-md-12">
                        ...
                        <tbody>
                            {
                                ...
                                <tr key={i}>
                                    ...
                                    <td className="textCenter">
                                        <Button onClick={() => this.showEditModal(todo)} bsStyle="info" bsSize="xsmall">
                                            <Glyphicon glyph="pencil" />
                                        </Button>
                                    </td>
                                    <td className="textCenter">
                                        <Button onClick={() => this.showDeleteModal(todo)} bsStyle="danger" bsSize="xsmall">
                ...
                <Modal show={todoState.showEditModal} onHide={this.hideEditModal} container={this} area-labelledby="contained-modal-title">
                ...
                <Modal show={todoState.showDeleteModal} onHide={this.hideDeleteModal} container={this} aria-labelledby="contained-modal-title">
                    <Modal.Header closeButton>
                        <Modal.Title id="contained-modal-title">Delete Your Todo</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        {
                    ...
                    <Modal.Footer>
                        {
                            ...
                            <div>
                                <Button onClick={this.confirmDeleteTodo}>Yes</Button>
